...
public class SwitchCaseChecker extends AbstractIndexAstChecker {
	public static final String MISS_CASE_ID = "com.baldapps.artemis.checkers.MissCaseProblem"; //$NON-NLS-1$
	public static final String MISS_DEFAULT_ID = "com.baldapps.artemis.checkers.MissDefaultProblem"; //$NON-NLS-1$

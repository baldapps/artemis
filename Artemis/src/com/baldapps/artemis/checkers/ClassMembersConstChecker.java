/*******************************************************************************
 * Copyright (c) 2011, 2019 Anton Gorenkov
 *
...
public class ClassMembersConstChecker extends AbstractIndexAstChecker {
	public static final String ER_ID_MemberCannotBeUsedInStatic = "com.baldapps.artemis.checkers.MemberCannotBeUsedInStatic"; //$NON-NLS-1$
	public static final String ER_ID_MethodShouldBeStatic = "com.baldapps.artemis.checkers.MethodShouldBeStatic"; //$NON-NLS-1$
	public static final String ER_ID_MemberCannotBeWritten = "com.baldapps.artemis.checkers.MemberCannotBeWritten"; //$NON-NLS-1$
	public static final String ER_ID_MethodShouldBeConst = "com.baldapps.artemis.checkers.MethodShouldBeConst"; //$NON-NLS-1$
